...
if( ! function_exists( 'woodmart_main_loop' ) ) {
	...
	function woodmart_main_loop() {
		...
		if ( $blog_design == 'masonry' || $blog_design == 'mask' ) {
			...
			$classes .= ' woodmart-spacing-' . $blog_spacing;
			$classes .= ' row';
		...
		?>
			...
			<?php if ( have_posts() ) : ?>
				...
				<?php if ( ! $is_ajax ): ?>
					<div class="woodmart-blog-holder <?php echo esc_attr( $classes ); ?>" id="<?php echo esc_attr( $id ); ?>" data-paged="1" data-source="main_loop">
				<?php endif ?>
					...
					<?php if ( $pagination == 'infinit' || $pagination == 'load_more' ): ?>
						<div class="blog-footer">
							<?php if( get_next_posts_link() ) :?>
								<a href="<?php echo add_query_arg( 'woo_ajax', '1', next_posts( $max_page, false ) ); ?>" rel="nofollow" data-holder-id="<?php echo esc_attr( $id ); ?>" class="btn woodmart-load-more woodmart-blog-load-more load-on-<?php echo 'load_more' === $pagination ? 'click' : 'scroll'; ?>"><span class="load-more-label"><?php esc_html_e('Load more posts', 'woodmart'); ?></span><span class="load-more-loading"><?php esc_html_e('Loading...', 'woodmart'); ?></span></a>
							<?php endif; ?>
						</div>
					<?php else: ?>
	...
	function woodmart_get_post_thumbnail( $size = 'medium', $attach_id = false ) {
		...
		if ( has_post_thumbnail() ) {
			...
			if( function_exists( 'wpb_getImageBySize' ) ) {
				...
				if( woodmart_loop_prop( 'img_size' ) ) $size = woodmart_loop_prop( 'img_size' );
...
if( ! function_exists( 'woodmart_header_banner' ) ) {
	function woodmart_header_banner() {
		...
		if ( ! woodmart_get_opt( 'header_banner' ) ) return;
...
if( ! function_exists( 'woodmart_full_screen_main_nav' ) ) {
	function woodmart_full_screen_main_nav() {
		if( ! whb_is_full_screen_menu() ) return;
	...
	add_action( 'wp_footer', 'woodmart_full_screen_main_nav', 120 );
}
