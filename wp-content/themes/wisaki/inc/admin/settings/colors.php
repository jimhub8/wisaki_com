...
Options::add_field(
	array(
		...
		'type'           => 'color',
		'section'        => 'colors_section',
		'selector'       => $selectors['link-color'][0],
		'selector_hover' => 'a:hover',
		'default'        => array(),
		'priority'       => 50,
	)
);
...
Options::add_field(
	array(
		'id'          => 'dark_version',
		'name'        => esc_html__( 'Dark version', 'woodmart' ),
		'description' => esc_html__( 'Turn your website color to dark version', 'woodmart' ),
		'group'       => esc_html__( 'Website dark version', 'woodmart' ),
		'type'        => 'switcher',
		'section'     => 'colors_section',
		'default'     => false,
		'priority'    => 60,
...
Options::add_field(
	array(
		...
		'default'  => array(),
		'section'  => 'buttons_section',
		'selector_bg' => current( $selectors['btns-default'] ),
		'priority' => 40,
	)
);
...
Options::add_field(
	array(
		...
		'default'     => array(),
		'section'     => 'buttons_section',
		'selector_bg' => woodmart_append_hover_state( $selectors['btns-default'], false ),
...
Options::add_field(
	array(
		...
		'type'     => 'color',
		'section'  => 'buttons_section',
		'selector_bg' => current( $selectors['btns-shop'] ),
		'default' => array(
			'idle' => '#83b735'
		),
		'priority' => 80,
...
Options::add_field(
	array(
		...
		'type'     => 'color',
		'section'  => 'buttons_section',
		'selector_bg' => woodmart_append_hover_state( $selectors['btns-shop'], false ),
		'default' => array(
			'idle' => '#74a32f'
		),
		'priority' => 100,
...
Options::add_field(
	array(
		...
		'type'     => 'color',
		'section'  => 'buttons_section',
		'selector_bg' => current( $selectors['btns-accent'] ),
		'default' => array(
			'idle' => '#83b735'
		),
		'priority' => 120,
...
Options::add_field(
	array(
		...
		'type'     => 'color',
		'section'  => 'buttons_section',
		'selector_bg' => woodmart_append_hover_state( $selectors['btns-accent'], false ),
		'default' => array(
			'idle' => '#74a32f'
		),
		'priority' => 140,
