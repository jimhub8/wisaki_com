	...
	woodmartOptions = (function () {
		...
		var woodmartOptionsAdmin = {
			...
			uploadControl: function () {
				...
				$uploads.each(function () {
					var $upload = $(this),
						...
						$inputURL = $upload.find('input.xts-upoad-input-url'),
						$inputID = $upload.find('input.xts-upoad-input-id'),
			...
			uploadListControl: function () {
				...
				$uploads.each(function () {
					var $upload = $(this);
					var $inputID = $upload.find('input.xts-upoad-input-id');
			...
			backgroundControl: function () {
				...
				$bgs.each(function () {
					var $bg = $(this),
						...
						$inputURL = $bg.find('input.xts-upoad-input-url'),
						$inputID = $bg.find('input.xts-upoad-input-id'),
		...
		return {
			init: function () {
				$(document).ready(function () {
					...
					woodmartOptionsAdmin.uploadControl();
					woodmartOptionsAdmin.uploadListControl();
