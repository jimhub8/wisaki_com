...
if ( ! function_exists('woodmart_settings_css') ) {
	function woodmart_settings_css() {
		...
		echo xts_get_header_css();
		
		echo xts_get_header_elements_css();
