...
class WOODMART_Cssgenerator {
	...
	public function form() {
		...
		<div class="xtemos-loader-wrapper">
			<div class="xtemos-loader">
				<div class="xtemos-loader-el">
					<img src="<?php echo WOODMART_ASSETS . '/images/loader/loader-el-1.svg'; ?>">
				</div>
				<div class="xtemos-loader-el">
					<img src="<?php echo WOODMART_ASSETS . '/images/loader/loader-el-2.svg'; ?>">
				</div>
			</div>
		...
		<p>
			...
			and this CSS code will not be loaded. You can make your CSS file up to 50% smaller and it
