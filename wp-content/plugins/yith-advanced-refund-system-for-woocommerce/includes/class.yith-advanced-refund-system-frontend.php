...
if ( ! class_exists( 'YITH_Advanced_Refund_System_Frontend' ) ) {
    ...
    class YITH_Advanced_Refund_System_Frontend {
        ...
        public function enqueue_scripts() {
            ...
            wp_localize_script( 'ywcars-frontend', 'localize_js_ywcars_frontend',
                array(
                    ...
                    'redirect_url'           => apply_filters( 'ywcars_submit_request_redirect_url', 'window.location.href' )
                )
            );
	    ...
	    public function refund_whole_order_button( $order ) {
		    ...
		    $text = apply_filters( 'ywcars_refund_entire_order_text', __( 'Refund my entire order', 'yith-advanced-refund-system-for-woocommerce' ), $order );
