...
if ( ! class_exists( 'YITH_Frontend_Manager_Section_Orders' ) ) {
	...
	class YITH_Frontend_Manager_Section_Orders extends YITH_WCFM_Section {
		...
		public function print_shortcode( $atts = array(), $content = '', $tag ) {
			...
			$atts['orders'] = apply_filters( 'yith_wcmv_print_orders_list_shortcode', array(), $atts['query_args'] );

            if( empty( $atts['orders'] ) ) {
		...
		public function orders_list_columns( $column, $order ){
            ...
            switch( $column ){
                ...
                case 'order':
                    printf( '<a href="%s">#%s</a>', $order_edit_url, $order_id );
                    break;
                ...
                case 'actions':
                    ...
                    foreach ( $actions as $action ) {
                        printf( '<a class="button tips %s" href="%s" data-tip="%s"></a>', esc_attr( $action['action'] ), esc_url( $action['url'] ), esc_attr( $action['name'] ) );
                    }
