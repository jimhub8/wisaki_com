...
if( ! class_exists( 'YITH_Frontend_Manager_GUI' ) ){
    ...
    class YITH_Frontend_Manager_GUI{
        ...
        public function register_style(){
	        ...
	        wp_register_script( 'jquery-ui-core', "/wp-includes/js/jquery/ui/core$suffix.js", array('jquery'), $jquery_version, true );
	        wp_register_script( 'jquery-ui-widget', "/wp-includes/js/jquery/ui/widget$suffix.js", array('jquery'), $jquery_version, true );
	        wp_register_script( 'jquery-ui-mouse', "/wp-includes/js/jquery/ui/mouse$suffix.js", array( 'jquery-ui-core', 'jquery-ui-widget' ), $jquery_version, true );
	        wp_register_script( 'jquery-ui-resizable', "/wp-includes/js/jquery/ui/resizable$suffix.js", array('jquery-ui-mouse'), $jquery_version, true );
	        wp_register_script( 'jquery-ui-draggable', "/wp-includes/js/jquery/ui/draggable$suffix.js", array('jquery-ui-mouse'), $jquery_version, true );
	        wp_register_script( 'jquery-ui-button', "/wp-includes/js/jquery/ui/button$suffix.js", array('jquery-ui-core', 'jquery-ui-widget'), $jquery_version, true );
	        wp_register_script( 'jquery-ui-position', "/wp-includes/js/jquery/ui/position$suffix.js", array('jquery'), $jquery_version, true );
